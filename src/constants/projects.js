const projects = [
  {
    ...
    seoTitle: 'LoveUI Case Study: React UI Library & AI Agent Skills | Connor Love',
    seoDescription: 'LoveUI is an open-source React and Tailwind UI library with docs, components, blocks, charts, icons, and AI agent skills.',
    seoKeywords: [
      'LoveUI',
      'LoveUI case study',
