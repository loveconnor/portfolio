...
const designTools = [
  ...
  },
  {
    ...
    icon: Film,
    image: "/abstract-motion-flow.png",
  },
  {
    name: "Blender",
    ...
    image: "/abstract-blender-scene.png",
  },
]
...
const devTools = [
  ...
  },
  {
    ...
    image: "/interactive-3d-globe.png",
  },
  {
    name: "PostCSS",
    description:
    ...
    image: "/abstract-postcss-flow.png",
  },
  {
    name: "Framer Motion",
              ...
              <div className={styles.grid}>
                {filteredTools().map((tool, index) => (
                  <article className={styles.card} key={index}>
                    <img src={tool.image || "/placeholder.svg"} alt={tool.name} className={styles.cardImage} />
