      ...
      case 1:
        return (
          <div className={styles.stepContent}>
            ...
            {errors.projectType && (
              <p className={styles.formError}>{errors.projectType.message}</p>
            )}
            ...
            <div className={styles.formField}>
              ...
              />
              {errors.projectName && (
                <p className={styles.formError}>{errors.projectName.message}</p>
              )}
            </div>
          </div>
        );
          ...
          <div className={styles.stepContent}>
            ...
            <div className={styles.formField}>
              ...
              {errors.projectDescription && (
                <p className={styles.formError}>{errors.projectDescription.message}</p>
              )}
            </div>
        ...
        return (
          <div className={styles.stepContent}>
            ...
            <div className={styles.optionSection}>
              ...
              {errors.budget && (
                <p className={styles.formError}>{errors.budget.message}</p>
              )}
            </div>
            ...
            <div className={styles.optionSection}>
              ...
              {errors.timeline && (
                <p className={styles.formError}>{errors.timeline.message}</p>
              )}
            </div>
          </div>
        );
