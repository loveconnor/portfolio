      ...
      <div className={styles.contactContainer}>
        ...
        <div className={styles.contentLayout}>
          ...
          <motion.div
            ...
            animate={
              isProjectSectionVisible ? { opacity: 1, y: 0 } : { opacity: 0, y: 30 }
            }
            transition={{ duration: 0.8 }}
          >
            <div className={styles.projectSectionContent}>
              ...
              <Text size="m" as="p" className={styles.projectSectionText}>
                Let&apos;s work together to bring your vision to life. Start the
                conversation by sharing your project details.
              </Text>
