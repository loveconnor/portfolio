...
export default async function handler(req, res) {
    ...
    const { name, email, projectName, projectType, projectDescription, budget, timeline, company, phone, files = [], } = req.body || {};

    if (!name || !email || !message || !projectName || !projectType || !projectDescription || !budget || !timeline || !company || !phone || !files) {
